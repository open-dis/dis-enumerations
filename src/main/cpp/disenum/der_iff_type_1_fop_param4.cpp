#include <sstream>
#include <cstddef>
#include <disenum/der_iff_type_1_fop_param4.h>
...
namespace der_iff_type_1_fop_param4 {
  ...
  void bitmask::setValue(const unsigned short& i){
	...
	short Codeelement1::endBit   = 11;

 Codeelement1 Codeelement1::PSEUDO_CRYPTO_VALUE(0, "Pseudo-Crypto value");
 Codeelement1 Codeelement1::NO_PSEUDO_CRYPTO_VALUE_USE_ALTERNATE_MODE_4_VALUE(4095, "No Pseudo-Crypto value. Use Alternate Mode 4 value");
