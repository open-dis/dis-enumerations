...
namespace es_appear_platform_air {
    ...
    unsigned int Canopy:3;
    unsigned int LandingLights:1;
    unsigned int NavigationLights:1;
    unsigned int Anti_CollisionLights:1;
    unsigned int Flaming:1;
    unsigned int Afterburner:1;
    unsigned int unused_2:4;
    unsigned int FrozenStatus:1;
    unsigned int Power_plantStatus:1;
    unsigned int State:1;
    unsigned int FormationLights:1;
  ...
  public:
	...
	class Propulsion : public Enumeration {
  public:
  ...
  public:
	...
	class Canopy : public Enumeration {
  public:
    static Canopy NOT_APPLICABLE;
    static Canopy CANOPY_IS_CLOSED;
    static Canopy CANOPY_IS_OPEN;
		...
		/** Returns the enumerated instance with this value.
		 * If there is no enumerated instance for this value, the exception is thrown.     */
		static Canopy getEnumerationForValue(int aVal) throw(EnumException);

		/** Returns true if there is an enumerated instance for this value, false otherwise. */
		static bool enumerationForValueExists(int aVal);

		typedef hashMap<int,Canopy*> enumContainer;
		static enumContainer getEnumerations();
	...
	private:
		/** Constructor */
		Canopy(int value, std::string description);

		static Canopy* findEnumeration(int aVal);
		static enumContainer enumerations;
	...
	class LandingLights : public Enumeration {
  public:
    static LandingLights OFF;
    static LandingLights ON;
		...
		/** Returns the enumerated instance with this value.
		 * If there is no enumerated instance for this value, the exception is thrown.     */
		static LandingLights getEnumerationForValue(int aVal) throw(EnumException);

		/** Returns true if there is an enumerated instance for this value, false otherwise. */
		static bool enumerationForValueExists(int aVal);

		typedef hashMap<int,LandingLights*> enumContainer;
		static enumContainer getEnumerations();
	...
	private:
		/** Constructor */
		LandingLights(int value, std::string description);

		static LandingLights* findEnumeration(int aVal);
		static enumContainer enumerations;
	...
	class NavigationLights : public Enumeration {
  public:
    static NavigationLights OFF;
    static NavigationLights ON;
		...
		/** Returns the enumerated instance with this value.
		 * If there is no enumerated instance for this value, the exception is thrown.     */
		static NavigationLights getEnumerationForValue(int aVal) throw(EnumException);

		/** Returns true if there is an enumerated instance for this value, false otherwise. */
		static bool enumerationForValueExists(int aVal);

		typedef hashMap<int,NavigationLights*> enumContainer;
		static enumContainer getEnumerations();
	...
	private:
		/** Constructor */
		NavigationLights(int value, std::string description);

		static NavigationLights* findEnumeration(int aVal);
		static enumContainer enumerations;
	...
	class Anti_CollisionLights : public Enumeration {
  public:
    static Anti_CollisionLights OFF;
    static Anti_CollisionLights ON;
		...
		/** Returns the enumerated instance with this value.
		 * If there is no enumerated instance for this value, the exception is thrown.     */
		static Anti_CollisionLights getEnumerationForValue(int aVal) throw(EnumException);

		/** Returns true if there is an enumerated instance for this value, false otherwise. */
		static bool enumerationForValueExists(int aVal);

		typedef hashMap<int,Anti_CollisionLights*> enumContainer;
		static enumContainer getEnumerations();
	...
	private:
		/** Constructor */
		Anti_CollisionLights(int value, std::string description);

		static Anti_CollisionLights* findEnumeration(int aVal);
		static enumContainer enumerations;

		static short startBit;
		static short endBit;

	};  /* Anti_CollisionLights */
  ...
  public:
	...
	class Afterburner : public Enumeration {
  public:
    static Afterburner AFTERBURNER_NOT_ON;
    static Afterburner AFTERBURNER_ON;
		...
		/** Returns the enumerated instance with this value.
		 * If there is no enumerated instance for this value, the exception is thrown.     */
		static Afterburner getEnumerationForValue(int aVal) throw(EnumException);

		/** Returns true if there is an enumerated instance for this value, false otherwise. */
		static bool enumerationForValueExists(int aVal);

		typedef hashMap<int,Afterburner*> enumContainer;
		static enumContainer getEnumerations();
	...
	private:
		/** Constructor */
		Afterburner(int value, std::string description);

		static Afterburner* findEnumeration(int aVal);
		static enumContainer enumerations;
  ...
  public:
	...
	class FormationLights : public Enumeration {
  public:
    static FormationLights OFF;
    static FormationLights ON;
		...
		/** Returns the enumerated instance with this value.
		 * If there is no enumerated instance for this value, the exception is thrown.     */
		static FormationLights getEnumerationForValue(int aVal) throw(EnumException);

		/** Returns true if there is an enumerated instance for this value, false otherwise. */
		static bool enumerationForValueExists(int aVal);

		typedef hashMap<int,FormationLights*> enumContainer;
		static enumContainer getEnumerations();
	...
	private:
		/** Constructor */
		FormationLights(int value, std::string description);

		static FormationLights* findEnumeration(int aVal);
		static enumContainer enumerations;
